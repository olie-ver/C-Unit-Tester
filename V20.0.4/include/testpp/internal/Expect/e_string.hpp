...
namespace internal {
    namespace Expects {
        ...
        inline void expectStringEquals(const std::string_view& first, const std::string_view& second, 
            const char* file, const int line) 
        {
            auto result = impl_str::stringEquals(first, second, file, line);
            if (result) {
        ...
        inline void expectStringNotEquals(const std::string_view& first, 
        ...
        inline void expectStringEmpty(const std::string_view& first, const char* file, const int line) {
            auto result = impl_str::stringEmpty(first, file, line);
            if (result) {
                Fail::e_fail(*result);
            }
        ...
        inline void expectStringNotEmpty(const std::string_view& first, const char* file, const int line) {
            auto result = impl_str::stringNotEmpty(first, file, line);
            if (result) {
                Fail::e_fail(*result);
            }
        ...
        //     }
        // }
        inline void expectStringContains(const std::string_view& first, const std::string_view& substr,
            const char* file, const int line)
        {
            auto result = impl_str::stringContains(first, substr, file, line);
            if (result) {
        ...
        //     }
        // }
        inline void expectStringStartsWith(const std::string_view& first, const std::string_view& substr, 
            const char* file, const int line)
        {
            auto result = impl_str::stringStartsWith(first, substr, file, line);
            if (result) {
        ...
        //     }
        // }
        inline void expectStringEndsWith(const std::string_view& first, const std::string_view& substr, 
            const char* file, const int line)
        {
            auto result = impl_str::stringEndsWith(first, substr, file, line);
            if (result) {
